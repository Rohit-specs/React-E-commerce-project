...
const HomeCarousel = () => {
  ...
  return (
    <Carousel fade={true} indicators={false} activeIndex={index} onSelect={(selectedIndex) => setIndex(selectedIndex)}>
      {carouselData.map((sliderData, i) => {
        const { title, description } = { ...sliderData }
        return (
          <Carousel.Item key={i}>

            <div className={`text-start ltn__slider-area ltn__slider-3 ltn__slider-6 section-bg-1 ${i === index ? "ltn__slide-animation-active" : ""}`}>
              <div className="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white---">
                <div className="ltn__slide-item ltn__slide-item-8 text-color-white---- bg-image bg-overlay-theme-black-80---" style={{
                          ...
                          <div className="slide-item-info">
                            ...
                            <div className="slide-item-info-inner ltn__slide-animation">
                              ...
                              <div className="btn-wrapper animated">
                                <Link href="/shop" className="theme-btn-1 btn btn-round" tabIndex="0">Shop Now</Link>
                              </div>
                            </div>
                          </div>
